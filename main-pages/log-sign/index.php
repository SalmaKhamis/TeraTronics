                ...
                <div class="card border-0">
                    ...
                    <div class="card-body rounded-bottom bg-primary p-5">
						<form action="" method="POST" class="login-email">
							...
							<input type="email" class="form-control border-0 p-4"placeholder="Email" name="email" value="<?php echo $email; ?>" required>
                            </div>
                            <div class="form-group">
							<input type="password" class="form-control border-0 p-4" placeholder="Password" name="password" value="<?php echo $_POST['password']; ?>" required>
                            </div>
                            <div>
								<button name="submit" class="btn btn-dark btn-block border-0 py-3">Login</button>

                            </div>
							<p style="color: black;padding:10px;">Don't have an account? <a  style="color: white;" href="register.php">Sign up Here</a>.</p>
